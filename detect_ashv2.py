...
def main(data_path, moment, output_path, clip_region=None):
    ...
    val_nhood = [1]
    nhood = np.select(cond_nhood, val_nhood, default=0) #np.where

    # Clasificación inicial por iluminación
    # Noche
    cond_noche = [
        ((delta1 < 0) & (delta2 > 0) & (delta3 > 2)) | (nhood == 1),
        ((delta1 < 1) & (delta2 > -0.5) & (delta3 > 2)) 
    ]
    ...
    cond_crepusculo = [
        ((delta1 < 0) & (delta2 > 0) & (delta3 > 2)) | (nhood == 1),
        ((delta1 < 1) & (delta2 > -0.5) & (delta3 > 2) & (c04 > 0.002) & (c13 < 273.15)) 
    ]
    ...
    cond_dia = [
        ((delta1 < 0) & (delta2 > 0) & (delta3 > 2)) | (nhood == 1),
        ((delta1 < 1) & (delta2 > -0.5) & (delta3 > 2) & (c04 > 0.002)) 
    ]
